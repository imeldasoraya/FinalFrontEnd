            ...
            <main class="flex gap-8">
                ...
                <form id="Form" method="POST" action="{{route('front.booking_store', $workshop->slug)}}" class="flex flex-col w-[724px] gap-8">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-[6px]">
                                    <p class="font-bold text-[32px] leading-[48px] text-aktiv-red">Rp {{$workshop->price}}</p>
                    ...
                    <div class="flex flex-col rounded-3xl p-8 gap-8 bg-white">
                        ...
                        <button type="submit" action="{{route('front.booking_store', $workshop->slug)}}" class="w-full rounded-xl h-16 px-6 text-center bg-aktiv-orange font-semibold text-lg leading-
